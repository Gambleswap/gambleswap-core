import {UniswapV2Router02, UniswapV2Router02__factory, UniToken, UniToken__factory} from '../../types'
...
async function main() {
    ...
    const router:UniswapV2Router02 = UniswapV2Router02__factory.connect(routerAddress, await getSigner(lpAddress));

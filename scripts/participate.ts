...
export async function participate(_gamblingAddress=undefined, _user=undefined, _pairAddress=undefined, _gmbAddress=undefined) {
    ...
    await gambling.participate(1, 1)
